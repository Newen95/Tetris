...
// paramètres d'entrée : pièce de format 4x2, angle de l'orientation
// paramètres de sortie : la pièce orientée de format 4x4

void rotation( int* piece8, int angle, int* pieceReorientee ) {
	int piece16[ 16 ];

	// conversion de la pièce de format 4x2 en pièce de format 4x4
...
// afficherLignePiece
// utilité : affiche la ligne souhaitée d'une pièce
// paramètres d'entrée : pièce de format 4x4, numéro de la ligne
// paramètres de sortie : rien
